...
class RepartoDao {
     ...
     */
    public function crea(Reparto $reparto): bool {
        $result = true;
     ...
     * @returns Bool Resultado de la operación
     */
    public function modifica(Reparto $reparto): bool {
     ...
     * @returns Bool Resultado de la operación
     */
    public function elimina(string $listaRepartoId, string $repartoId): bool {
        $result = true;
        try {
