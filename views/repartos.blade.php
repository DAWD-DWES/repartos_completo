                ...
                <th scope="col" class="text-end">
                    <form action="index.php" method="POST" id="acciones-lr">
                        <div class="btn-group" role="group">
                            ...
                            <button class="btn btn-success mr-2 btn-sm ordenar" id="ordenar"><i class="bi bi-sort-down me-1"></i>ordenar</button>
        ...
        <td scope="row" class="text-end">
            <form action="index.php" method="POST" id="acciones-lr">
                <div class="btn-group" role="group">
                    ...
                    <button type="submit" name="mapa-reparto" class="btn btn-info ml-2 btn-sm ver-coordenadas"><i class="bi bi-geo-alt-fill"></i>Mapa</button>
                </div>
            </form>
        </td>
